...
โหมด merchant ใช้ **static payload ต้นฉบับจากแอปถุงเงิน** ของร้าน (ข้อความยาวขึ้นต้น
`000201...`) — ระบบฉีดยอดเงิน (tag 54) เข้าไปหลัง tag 53 แล้วคำนวณ CRC (tag 63)
...
2. ใน POS: admin เปิด **ตั้งค่าระบบ > การชำระเงิน** แล้ว
   ...
   - ถ้าต้องเปลี่ยน: กด **เปลี่ยน QR ร้านค้า** แล้ววาง static payload ใหม่จากแอปถุงเงิน
     (เซิร์ฟเวอร์ตรวจโครงสร้าง EMVCo + AID ก่อนบันทึก)
