...
> อัปเดตล่าสุด: 20 กรกฎาคม 2026 — source/build ในเครื่อง `1.0.24`; รุ่นเผยแพร่บน GCS `1.0.24`; เว็บออนไลน์ deploy ที่ Vercel + Railway (ดูหัวข้อ 11)

## 1. สถานะปัจจุบัน

| รายการ            | สถานะ                                                               |
| ----------------- | ------------------------------------------------------------------- |
| เวอร์ชันใน source | `1.0.24`                                                            |
| รุ่นเผยแพร่ล่าสุด | `1.0.24`                                                            |
| Branch หลัก       | `main`                                                              |
...
- [POS-Pump-Setup-1.0.24.exe](https://storage.googleapis.com/kimi-agent-pos-updates/POS-Pump-Setup-1.0.24.exe)
- [POS-Pump-Portable-1.0.24.exe](https://storage.googleapis.com/kimi-agent-pos-updates/POS-Pump-Portable-1.0.24.exe)
- [latest.yml](https://storage.googleapis.com/kimi-agent-pos-updates/latest.yml)

รุ่น `1.0.21` เพิ่ม Wizard ภาษาไทยพร้อม EULA/โลโก้ KY ติดตั้งแบบ per-machine ใน `Program Files`, ฟีเจอร์พนักงานและตารางงาน (workforce), admin จัดการประวัติตัดกะ และ config deploy เว็บออนไลน์ รุ่น `1.0.22` เพิ่มการบันทึกเลขมิเตอร์เปิด–ปิดรายหัวจ่ายตอนสร้าง/แก้ประวัติตัดกะ พร้อมคำนวณยอดรวมให้อัตโนมัติ และรุ่น `1.0.23` แก้ scrollbar ซ้อนกันบนจอเล็ก — Layout เปลี่ยนไป scroll ที่ document ทำให้เปิด dialog แล้วพื้นหลัง lock สนิท รุ่น `1.0.24` (เผยแพร่ 20 กรกฎาคม 2026) เริ่ม sign ทุก executable ด้วย self-signed certificate (`CN=PumpPOS Code Signing`) เพื่อให้ Windows Smart App Control ยอมรับ — เครื่องปลายทางต้อง import root cert ครั้งเดียวด้วย `certs/install-pos-root-cert.bat` ที่แนบในตัวติดตั้ง (รายละเอียด `plan-desktop.md` หัวข้อ D17) — ทุกรุ่นอัปโหลด installer + Portable + blockmap + `latest.yml` ขึ้น GCS แล้ว (ไม่ได้สร้าง git tag เช่นเดียวกับรุ่น `1.0.18` เป็นต้นมา)
