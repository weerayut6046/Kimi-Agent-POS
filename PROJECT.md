...
> อัปเดตล่าสุด: 21 กรกฎาคม 2026 — source/build ในเครื่อง `2.0.1`; รุ่นเผยแพร่บน GCS `2.0.1`; เว็บออนไลน์ deploy ที่ Vercel + Railway (ดูหัวข้อ 11)

## 1. สถานะปัจจุบัน

| รายการ            | สถานะ                                                               |
| ----------------- | ------------------------------------------------------------------- |
| เวอร์ชันใน source | `2.0.1`                                                             |
| รุ่นเผยแพร่ล่าสุด | `2.0.1`                                                             |
| Branch หลัก       | `main`                                                              |
...
- [POS-Pump-Setup-2.0.1.exe](https://storage.googleapis.com/kimi-agent-pos-updates/POS-Pump-Setup-2.0.1.exe)
- [POS-Pump-Portable-2.0.1.exe](https://storage.googleapis.com/kimi-agent-pos-updates/POS-Pump-Portable-2.0.1.exe)
- [latest.yml](https://storage.googleapis.com/kimi-agent-pos-updates/latest.yml)

รุ่น `1.0.21`–`1.0.24` เพิ่ม Wizard ภาษาไทย, workforce, มิเตอร์ประวัติกะ, แก้ responsive UI และเริ่ม sign executable ด้วย self-signed certificate (`CN=PumpPOS Code Signing`) รุ่น `2.0.0` (เผยแพร่ 21 กรกฎาคม 2026) ย้ายข้อมูลจาก SQLite ขึ้น Supabase PostgreSQL ใน private schema `pos` และเปลี่ยน Desktop เป็น shell ที่โหลดระบบกลาง รุ่น `2.0.1` เพิ่มระบบ Logical Backup ไป Private GCS ทุก 6 ชั่วโมง, หน้าติดตาม/ดาวน์โหลด Backup, ย้าย Railway ไป Singapore, รวม Dashboard query และบันทึก Settings แบบ bulk เพื่อลด latency — installer + Portable + blockmap + `latest.yml` เผยแพร่ผ่าน GCS
...
- ไม่อนุญาต Restore/ลบ Backup จากแอป production; ใช้ขั้นตอนใน [`docs/database-backup-restore.md`](./docs/database-backup-restore.md)
