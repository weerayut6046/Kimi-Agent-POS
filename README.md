...
- Computer vision แบบ deterministic อ่าน seven-segment ในเครื่องด้วย threshold หลาย channel พร้อมวัดแสงสะท้อนและโหวตค่าที่ตรงกันอย่างน้อย 2 ใน 3 จากนั้น Gemini Vision อ่านภาพเดิมแบบอิสระโดยไม่เห็นผล local OCR
