...
- แอป Desktop โหลดระบบกลางจาก `https://kimi-agent-pos.vercel.app` และใช้ฐานข้อมูล Supabase เดียวกับเว็บ จึงต้องเชื่อมต่ออินเทอร์เน็ต
...
- ข้อมูลอยู่ใน Supabase PostgreSQL และสำรองสองชั้น: Supabase Pro Daily Backup 7 วัน + Logical Backup ทุก 6 ชั่วโมงไป Private GCS (35 วัน/รายเดือน 370 วัน); ดูสถานะและดาวน์โหลดได้จากหน้า Settings ส่วนการกู้คืนต้องผ่านฐานทดสอบตาม [`docs/database-backup-restore.md`](./docs/database-backup-restore.md)
