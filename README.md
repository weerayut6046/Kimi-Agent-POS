...
- หน้าจัดการกะรองรับการเลือก JPG/PNG/WebP หลายภาพหรือถ่ายเพิ่มทีละภาพ ระบบย่อภาพ ลบ metadata และประมวลผลทั้งหมดในเครื่องผู้ใช้
- Computer vision แบบ deterministic ตรวจหาจอและอ่าน seven-segment ด้วย threshold หลายชุด โดยต่อเลขหลักนำหน้าด้านบนกับเลขบรรทัดล่างเป็น string ก่อนแปลงเป็นตัวเลข เช่น `L 42` + `0105.81` = `420105.81`
...
- รูปอยู่ในหน่วยความจำของหน้าเว็บชั่วคราว ไม่ส่งไป backend/AI และไม่บันทึกลงฐานข้อมูล; หากอ่านไม่ครบ ผู้ใช้ยังตรวจแก้หรือกรอกมิเตอร์ด้วยตนเองได้ตามเดิม
