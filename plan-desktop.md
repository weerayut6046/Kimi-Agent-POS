...
> อัปเดตล่าสุด: 21 กรกฎาคม 2026 — source/build และรุ่นเผยแพร่ `2.0.3` ดูภาพรวมโครงการได้ที่ [`PROJECT.md`](./PROJECT.md)
...
- [ ] **D16 — ทดสอบ updater รุ่นใหม่**: ทดสอบ `2.0.2` → `2.0.3` แบบ end-to-end และบันทึกผล
