...
> อัปเดตล่าสุด: 22 กรกฎาคม 2026 — source/build และรุ่นเผยแพร่ `2.0.4` ดูภาพรวมโครงการได้ที่ [`PROJECT.md`](./PROJECT.md)
...
- [ ] **D16 — ทดสอบ updater รุ่นใหม่**: ทดสอบ `2.0.3` → `2.0.4` แบบ end-to-end และบันทึกผล
