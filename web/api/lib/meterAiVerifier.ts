...
ภาพอาจเป็นแผ่นตรวจสอบที่มีภาพเต็มของตู้ด้านบน และภาพขยาย LEFT DISPLAY / RIGHT DISPLAY ด้านล่าง
ให้ใช้ภาพเต็มเพื่อดูเลขตู้และโหมด และใช้ภาพขยายเพื่อตรวจเส้นของตัวเลข โดยข้อความกำกับภาษาอังกฤษไม่ใช่ค่ามิเตอร์
