...
declare global {
  interface Window {
    posDesktop?: {
      ...
      retrySync(staffToken?: string): Promise<DesktopSyncStatus>;
      exportOfflineRecovery(): Promise<DesktopOfflineRecoveryResult>;
      importOfflineRecovery(): Promise<DesktopOfflineRecoveryResult>;
